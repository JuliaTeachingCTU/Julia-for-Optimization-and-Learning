...
<header class="admonition-header">Interactive package generation</header>
<div class="admonition-body"><p>
```
...
```@raw html
<div class="admonition is-info">
<header class="admonition-header">Creating reports</header>
<div class="admonition-body"><p>
```
...
```@raw html
<div class="admonition is-info">
<header class="admonition-header">Optional dependencies</header>
<div class="admonition-body"><p>
```
